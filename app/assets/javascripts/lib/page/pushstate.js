define([
  ...
  PushState.prototype._handlePopState = function() {
    if ( !this.popStateFired ){
      ...
      if ( this.getUrl() === this.currentUrl )
        return;
    }
  ...
  PushState.prototype._supportsHistory = function() {
    if (this.isHistoryEnabled !== undefined ) return this.isHistoryEnabled;
  ...
  PushState.prototype._supportsHash = function() {
    if ( this.isHashEnabled !== undefined ) return this.isHashEnabled;
